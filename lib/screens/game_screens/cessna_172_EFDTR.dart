...
class Cessna172EFDTR extends StatefulWidget {
  const Cessna172EFDTR({super.key});

  @override
  _Cessna172EFDTR createState() => _Cessna172EFDTR();
}

class _Cessna172EFDTR extends State<Cessna172EFDTR> {
