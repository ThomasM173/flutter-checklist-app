...
class Cessna172EFATRA extends StatefulWidget {
  const Cessna172EFATRA({super.key});

  @override
  _Cessna172EFATRA createState() => _Cessna172EFATRA();
}

class _Cessna172EFATRA extends State<Cessna172EFATRA> {
