...
class Cessna152EmergencyScreen extends StatefulWidget {
  ...
  @override
  State<Cessna152EmergencyScreen> createState() =>
      _Cessna152EmergencyScreenState();
}
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () =>
                                      _toggleItem(title, index, !isChecked),
                                  child: Container(
                                    width: 24,
                                    height: 24,
            ...
            children: [
              ...
              _iconButton(
                ...
                () => Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (_) => const Cessna152EmergencyDetailsScreen()),
                ),
              ),
            ],
          ),
